...
public final class g0 extends i0 {
    ...
    public g0(l0 l0Var, l0 l0Var2) {
        ...
        if (l0Var instanceof g0) {
            hashSet.addAll(Arrays.asList(((g0) l0Var).d));
        } else {
            hashSet.add(l0Var);
        }
        if (l0Var2 instanceof g0) {
            hashSet.addAll(Arrays.asList(((g0) l0Var2).d));
        } else {
            hashSet.add(l0Var2);
        }
        List a = l0.a(hashSet);
        if (!a.isEmpty()) {
            hashSet.add((j0) Collections.min(a));
        }
        ...
        while (true) {
            if (i >= length) {
                ...
                while (r6 < arrayList.size()) {
                    l0Var = l0.b(l0Var, (l0) arrayList.get(r6));
                    r6++;
                }
                return l0Var;
            }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof g0) {
            return Arrays.equals(this.d, ((g0) obj).d);
        }
        return false;
    }
    ...
    public final int hashCode() {
        l0[] l0VarArr = this.d;
        int hashCode = g0.class.hashCode();
    ...
    public final String toString() {
        return com.github.catvod.spider.merge.F.f.a(Arrays.asList(this.d).iterator(), cYh.d("4176"));
    }
}
