...
public final class k {
    ...
    public static void A(String str, final String str2, String str3, final j jVar) {
        DialogInterface.OnCancelListener onCancelListener;
        String d2 = cYh.d("8EFACDB9F8DB80F0C0");
        try {
            ...
            if (i.indexOf(d2) >= 0) {
                ...
                builder.setNegativeButton(cYh.d("82DFD7B7E1D2"), new DialogInterface.OnClickListener() { // from class: com.github.catvod.spider.merge.j.d
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i2) {
                        k.f.cancel();
                    }
                });
                builder.setPositiveButton(cYh.d("80F1EFB4F9C0"), new DialogInterface.OnClickListener() { // from class: com.github.catvod.spider.merge.j.c
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i2) {
                        k.b(str2, jVar, dialogInterface);
                    }
                });
                onCancelListener = new DialogInterface.OnCancelListener() { // from class: com.github.catvod.spider.merge.j.a
                    @Override // android.content.DialogInterface.OnCancelListener
                    public final void onCancel(DialogInterface dialogInterface) {
                        k.c(j.this, dialogInterface);
                    }
                };
            } else {
                builder.setView((FrameLayout) y(e, str2, str3));
                onCancelListener = new DialogInterface.OnCancelListener() { // from class: com.github.catvod.spider.merge.j.b
                    @Override // android.content.DialogInterface.OnCancelListener
                    public final void onCancel(DialogInterface dialogInterface) {
                        k.d(str2, jVar, dialogInterface);
                    }
                };
            }
            ...
            f = create;
            create.setOnDismissListener(new DialogInterface.OnDismissListener() { // from class: com.github.catvod.spider.merge.j.e
    ...
    public static /* synthetic */ void b(String str, j jVar, DialogInterface dialogInterface) {
        ...
        if (cookie != null && cookie.length() > 1) {
            ...
            String d2 = cYh.d("5C");
            sb.append(d2);
            String replaceAll = sb.toString().replaceAll(cYh.d("0A31220E3F3314242E232E050A28312338673C0E7A0C7C655C"), "");
            if (replaceAll.endsWith(d2)) {
                replaceAll = replaceAll.substring(0, replaceAll.length() - 1);
            }
            str2 = userAgentString + cYh.d("44") + replaceAll + cYh.d("437465");
        }
        if (jVar != null) {
            EditText editText = d;
            jVar.vertifyCode(str2 + ((editText == null || editText.length() <= 1) ? cYh.d("56") : d.getText().toString()));
        }
        x();
    ...
    public static Object y(Context context, String str, String str2) {
        ...
        c = webView;
        webView.setWebChromeClient(new C0157f());
        ...
        a.removeSessionCookie();
        if (str2.length() > 0) {
            for (String str4 : str2.split(cYh.d("5C"))) {
                a.setCookie(str, str4);
            }
            if (Build.VERSION.SDK_INT < 21) {
                CookieSyncManager.getInstance().sync();
            } else {
        ...
        c.requestFocus();
        ((InputMethodManager) context.getSystemService(cYh.d("0E3E312423050A353539383E"))).showSoftInput(c, 2);
        return frameLayout;
    }
