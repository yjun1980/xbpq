...
public final class r extends com.github.catvod.spider.merge.P.x {
    public r(com.github.catvod.spider.merge.P.x xVar, int i) {
        super(xVar, i);
    }
    ...
    public final <T> T e(com.github.catvod.spider.merge.T.d<? extends T> dVar) {
        return dVar instanceof E ? (T) ((E) dVar).n(this) : dVar.A(this);
    }
