...
public final class p extends com.github.catvod.spider.merge.P.x {
    public p(com.github.catvod.spider.merge.P.x xVar, int i) {
        super(xVar, i);
    }
    ...
    public final <T> T e(com.github.catvod.spider.merge.T.d<? extends T> dVar) {
        return dVar instanceof E ? (T) ((E) dVar).j(this) : dVar.A(this);
    }
