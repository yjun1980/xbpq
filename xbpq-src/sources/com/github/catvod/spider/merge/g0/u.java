...
public final class u extends com.github.catvod.spider.merge.P.x {
    public u(com.github.catvod.spider.merge.P.x xVar, int i) {
        super(xVar, i);
    }
    ...
    public final <T> T e(com.github.catvod.spider.merge.T.d<? extends T> dVar) {
        return dVar instanceof E ? (T) ((E) dVar).m(this) : dVar.A(this);
    }
