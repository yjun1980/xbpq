...
public final class y extends com.github.catvod.spider.merge.P.x {
    public com.github.catvod.spider.merge.P.D g;

    public y(com.github.catvod.spider.merge.P.x xVar, int i) {
        super(xVar, i);
    }
    ...
    public final <T> T e(com.github.catvod.spider.merge.T.d<? extends T> dVar) {
        return dVar instanceof E ? (T) ((E) dVar).r(this) : dVar.A(this);
    }
