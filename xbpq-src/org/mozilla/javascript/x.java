...
implements Runnable {
    ...
    public /* synthetic */ x(NativePromise nativePromise, NativePromise$Reaction nativePromise$Reaction, Context context, Scriptable scriptable) {
    ...
    public final void run() {
        NativePromise.p(this.a, this.b, this.c, this.d);
    }
}
