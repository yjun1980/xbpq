...
implements Callable {
    ...
    public /* synthetic */ D(NativePromise$ResolvingFunctions nativePromise$ResolvingFunctions, NativePromise nativePromise) {
    ...
    public final Object call(Context context, Scriptable scriptable, Scriptable scriptable2, Object[] objectArray) {
        return NativePromise$ResolvingFunctions.c(this.a, this.b, context, scriptable, scriptable2, objectArray);
    }
}
