...
public class MixWeb {
    ...
    public static Object[] loadHtml(String object, String object2) {
        ...
        block6: {
            ...
            string2 = cYh.d("3204077C6F");
            string = new String(Base64.decode((String)object2, (int)10), string2);
            ...
            while (true) {
                ...
                stringBuilder.append((String)((ArrayList)object).get(n2));
                stringBuilder.append(string3);
                if (n2 < ((ArrayList)object).size() - 1) {
                    stringBuilder.append(cYh.d("4B"));
                }
                ++n2;
                continue;
                break;
        ...
        try {
            object2 = ((String)object2).replace(cYh.d("4425333D74"), string).replace(cYh.d("443A392274"), stringBuilder.toString());
            object = cYh.d("133539257832133D2D6A77390F313322322E5A72140511775F72");
            object2 = new ByteArrayInputStream(((String)object2).toString().getBytes(string2));
        }
