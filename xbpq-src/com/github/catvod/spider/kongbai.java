...
extends NetPan {
    ...
    public native kongbai();

    public static native String o(kongbai var0, String var1);

    private native void p(List var1, String var2);

    private static native void q(m var0, Matcher var1, List var2);

    private native Map r();

    private native List s(h var1);

    private native String t(String var1);
