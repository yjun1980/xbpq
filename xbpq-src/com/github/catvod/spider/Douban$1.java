...
implements Douban$MUrlBuilder {
    ...
    Douban$1(String string, String string2) {
        this.a = string;
        this.b = string2;
    }
    ...
    public String build(int n2, int n3) {
        ...
        stringBuilder.append("https://m.douban.com/rexxar/api/v2/subject/recent_hot/movie?start=");
        stringBuilder.append(n2);
        stringBuilder.append("&limit=");
        stringBuilder.append(n3);
        stringBuilder.append("&category=");
        stringBuilder.append(Douban.e(this.a));
