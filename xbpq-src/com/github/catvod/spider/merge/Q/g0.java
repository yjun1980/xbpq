...
extends i0 {
    ...
    public g0(l0 object, l0 l02) {
        HashSet<l0> hashSet = new HashSet<l0>();
        if (object instanceof g0) {
            hashSet.addAll(Arrays.asList(((g0)object).d));
        } else {
            hashSet.add((l0)object);
        }
        if (l02 instanceof g0) {
            hashSet.addAll(Arrays.asList(((g0)l02).d));
        } else {
            hashSet.add(l02);
        }
        object = l0.a(hashSet);
        if (!object.isEmpty()) {
            hashSet.add((j0)Collections.min(object));
        }
    ...
    public final l0 d(B<?, ?> object, C c2) {
        ...
        for (n3 = n4; n3 < arrayList.size(); ++n3) {
            object = l0.b((l0)object, (l0)arrayList.get(n3));
        }
        return object;
    }
    ...
    public final boolean equals(Object object) {
        ...
        object = (g0)object;
        return Arrays.equals(this.d, ((g0)object).d);
    }

    public final int hashCode() {
        l0[] l0Array = this.d;
        int n2 = g0.class.hashCode();
    ...
    public final String toString() {
        return f.a(Arrays.asList(this.d).iterator(), cYh.d("4176"));
    }
}
