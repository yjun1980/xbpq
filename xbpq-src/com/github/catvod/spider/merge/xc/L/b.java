...
public final class b {
    ...
    public static b a(String object, Map map) {
        ...
        object2 = object != null && !((String)object).isEmpty() ? ((String)object).replace("&#39;", "'").replace("&#34;", "\"").replace("&#38;", "&").replace("&#60;", "<").replace("&#62;", ">").replace("&apos;", "'").replace("&quot;", "\"").replace("&amp;", "&").replace("&lt;", "<").replace("&gt;", ">") : object;
        b2.e = object2;
        if (!((String)object).equals(object2)) {
            object = m.i("[Item] HTML\u89e3\u7801: ", (String)object, " -> ");
            ((StringBuilder)object).append(b2.e);
