...
implements Runnable {
    ...
    public /* synthetic */ v(String string, String string2, String string3, String string4, u u2) {
        this.a = string;
        this.b = string2;
        this.c = string3;
        this.d = string4;
    ...
    public final void run() {
        ...
        try {
            ...
            string2 = com.github.catvod.spider.merge.xc.a.a.G(string2, false);
            string3 = com.github.catvod.spider.merge.xc.a.a.G(string3, bl);
            object = new LinearLayout.LayoutParams(-1, C.j(58));
            linearLayout.addView((View)string2, (ViewGroup.LayoutParams)object);
            object = new LinearLayout.LayoutParams(-1, C.j(58));
            object.setMargins(0, C.j(12), 0, 0);
            linearLayout.addView((View)string3, (ViewGroup.LayoutParams)object);
            ...
            string4 = com.github.catvod.spider.merge.xc.a.a.E(string4, true);
            textView.addView((View)object, (ViewGroup.LayoutParams)com.github.catvod.spider.merge.xc.a.a.F(true));
            textView.addView((View)string4, (ViewGroup.LayoutParams)com.github.catvod.spider.merge.xc.a.a.F(false));
            ...
            t t2 = new t((AlertDialog)textView, 2);
            object.setOnClickListener((View.OnClickListener)t2);
            object = new E((EditText)string2, (EditText)string3, (AlertDialog)textView, (u)object2);
            string4.setOnClickListener((View.OnClickListener)object);
            object2 = new D((Button)string4, 1);
            string3.setOnEditorActionListener((TextView.OnEditorActionListener)object2);
            textView.show();
