...
implements Interpolator {
    ...
    public final float getInterpolation(float f2) {
        ...
        float[] fArray = this.a;
        int n2 = Math.min((int)((float)(fArray.length - 1) * f2), fArray.length - 2);
        float f4 = n2;
        float f5 = this.b;
        f2 = (f2 - f4 * f5) / f5;
        f5 = fArray[n2];
        return (fArray[n2 + 1] - f5) * f2 + f5;
    }
}
