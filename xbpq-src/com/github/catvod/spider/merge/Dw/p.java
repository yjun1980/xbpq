    ...
    public static boolean a(CharSequence charSequence, CharSequence charSequence2) {
        ...
        if (charSequence != null && charSequence2 != null) {
            if (charSequence2.length() <= charSequence.length()) {
                bl = com.github.catvod.spider.merge.Dw.a.b((CharSequence)charSequence, (boolean)false, (int)(charSequence.length() - charSequence2.length()), (CharSequence)charSequence2, (int)charSequence2.length());
            }
    ...
    public static String h(String string, String string2, String string3) {
        ...
        if (!p.c(string)) {
            ...
            if (!p.c(string2)) {
                ...
                if (string3 != null) {
                    int n2 = 0;
                    int n3 = string != null && string2 != null ? com.github.catvod.spider.merge.Dw.a.a((CharSequence)string, (CharSequence)string2, (int)0) : -1;
                    if (n3 == -1) {
                        charSequence = string;
                    } else {
                        ...
                        while (true) {
                            ...
                            n6 = com.github.catvod.spider.merge.Dw.a.a((CharSequence)string, (CharSequence)string2, (int)n3);
                        }
