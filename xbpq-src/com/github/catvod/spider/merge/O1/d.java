...
implements a {
    ...
    final LinkedBlockingQueue<com.github.catvod.spider.merge.N1.c> c = new LinkedBlockingQueue();
    ...
    public final LinkedBlockingQueue<com.github.catvod.spider.merge.N1.c> c() {
        return this.c;
    }
