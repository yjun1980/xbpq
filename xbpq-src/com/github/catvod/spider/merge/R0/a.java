...
public final class a {
    ...
    static boolean b(CharSequence charSequence, int n2, CharSequence charSequence2, int n3) {
        if (charSequence instanceof String && charSequence2 instanceof String) {
            return ((String)charSequence).regionMatches(true, n2, (String)charSequence2, 0, n3);
        }
        ...
        if (n2 >= 0 && n3 >= 0 && n4 - n2 >= n3 && n5 - 0 >= n3) {
            ...
            while (n3 > 0) {
                ...
                if (c3 != (c2 = charSequence2.charAt(n2)) && (c3 = Character.toUpperCase(c3)) != (c2 = Character.toUpperCase(c2)) && Character.toLowerCase(c3) != Character.toLowerCase(c2)) {
                    return false;
                }
                ++n4;
                --n3;
