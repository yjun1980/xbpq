...
import com.github.catvod.spider.merge.Em.q;
...
implements Cloneable {
    ...
    public String a(String string) {
        ...
        return com.github.catvod.spider.merge.Dw.e.h(uRL, string).toExternalForm();
        {
    ...
    protected final void r(Appendable appendable, int n2, g g2) {
        appendable.append('\n').append(com.github.catvod.spider.merge.Dw.e.f(g2.d() * n2));
    }
    ...
    protected final void v(Appendable appendable) {
        ...
        com.github.catvod.spider.merge.Dw.q.c(new q(appendable, h2.s0()), this);
    }
