...
public final class a {
        ...
        if (string == null) {
            ...
            if (n3 == string.length()) {
                ...
                while (true) {
                    bl2 = bl;
                    if (n6 != 0) {
                        if (object[n4] != string.charAt(n5)) break;
                        ++n4;
                        --n6;
                        ++n5;
                        continue;
    ...
    final void F() {
        ...
        throw new b(new IOException(cYh.d("2A31333A77330926203D3E3E")));
    }
    ...
    final void G() {
        ...
        throw new b(new IOException(cYh.d("3004076B771408702324313C0222613D323C1370353E772F09332E3F242F0A356F")));
    }
...
lbl12:
    ...
    final String f(boolean bl) {
        ...
        this.e = n2;
        object = n2 > n3 ? (Object)com.github.catvod.spider.merge.d0.a.c(this.a, this.h, n3, n2 - n3) : (Object)"";
        return object;
    }
    ...
    final String h() {
        ...
        return com.github.catvod.spider.merge.d0.a.c(this.a, this.h, n3, n2 - n3);
    }
    ...
    final String j() {
        ...
        return com.github.catvod.spider.merge.d0.a.c(this.a, this.h, n3, this.e - n3);
    }
    ...
    final String k() {
        ...
        this.b();
        int n3 = this.e;
        while ((n2 = ++this.e) < this.c && ((c3 = this.a[n2]) >= 'A' && c3 <= 'Z' || c3 >= 'a' && c3 <= 'z' || Character.isLetter(c3))) {
        }
        while (!this.u() && (c2 = (cArray = this.a)[n2 = this.e]) >= '0' && c2 <= '9') {
            this.e = n2 + 1;
        }
        return com.github.catvod.spider.merge.d0.a.c(this.a, this.h, n3, this.e - n3);
    }
    ...
    final String n() {
        int n2 = this.D(cYh.d("3A0D7F"));
        if (n2 != -1) {
            String string = com.github.catvod.spider.merge.d0.a.c(this.a, this.h, this.e, n2);
            this.e += n2;
            return string;
        }
        int n3 = this.c;
        ...
        n3 = n3 - 3 + 1;
        String string = com.github.catvod.spider.merge.d0.a.c(this.a, this.h, n2, n3 - n2);
        this.e = n3;
        return string;
    }
    ...
    public final String o(char c2) {
        ...
        if (c2 != '\uffffffff') {
            String string = com.github.catvod.spider.merge.d0.a.c(this.a, this.h, this.e, c2);
            this.e += c2;
            return string;
        }
        return this.r();
    ...
    final String r() {
        ...
        int n2 = this.e;
        object = com.github.catvod.spider.merge.d0.a.c(cArray, object, n2, this.c - n2);
        this.e = this.c;
        return object;
    }
