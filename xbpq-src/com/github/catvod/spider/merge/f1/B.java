...
import com.github.catvod.spider.merge.f1.p;
import com.github.catvod.spider.merge.f1.q;
import com.github.catvod.spider.merge.f1.r;
...
extends Enum<B> {
    ...
    static {
        ...
        w = q2 = new q();
        x = r2 = new r();
        z = new B[]{m2, s2, t2, u2, v2, w2, x2, y2, z2, c2, d2, e2, f2, g2, h2, i2, j2, k2, l2, n2, o2, p2, q2, r2};
        y = String.valueOf('\u0000');
    }
    ...
    static boolean b(P p2) {
        boolean bl = p2.b() ? com.github.catvod.spider.merge.d1.c.d(((I)p2).l()) : false;
        return bl;
    }

    static void e(N n2, b b2) {
        b2.c.v(i1.e);
        b2.S();
        b2.s0(h);
        b2.H(n2);
    ...
    abstract boolean i(P var1, b var2);
}
