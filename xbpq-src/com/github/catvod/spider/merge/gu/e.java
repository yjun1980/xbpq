        ...
        if (n3 != 0) {
            if (n3 != 1) {
                if (n3 == 2 && this.d.remaining() < n2) {
                    object2 = IntBuffer.allocate(com.github.catvod.spider.merge.gu.e.e(this.d.capacity() + n2));
                    this.d.flip();
                    ((IntBuffer)object2).put(this.d);
                    this.d = object2;
                }
            } else if (this.c.remaining() < n2) {
                object2 = CharBuffer.allocate(com.github.catvod.spider.merge.gu.e.e(this.c.capacity() + n2));
                this.c.flip();
                ((CharBuffer)object2).put(this.c);
                this.c = object2;
            }
        } else if (this.b.remaining() < n2) {
            object2 = ByteBuffer.allocate(com.github.catvod.spider.merge.gu.e.e(this.b.capacity() + n2));
            this.b.flip();
        ...
        if (((CharBuffer)object).hasArray()) {
            block19: {
                ...
                if (n3 != 0) {
                    ...
                    object2 = ((CharBuffer)object).array();
                    n3 = ((CharBuffer)object).arrayOffset();
                    n2 = ((Buffer)object).position() + n3;
                    int n4 = ((CharBuffer)object).arrayOffset();
                    int n5 = ((Buffer)object).limit();
                    byte[] byArray = this.b.array();
                    n3 = this.b.arrayOffset();
                    n3 = this.b.position() + n3;
                    while (n2 < n5 + n4) {
                        Object object3 = object2[n2];
                        if (object3 <= 255) {
                            byArray[n3] = (byte)(object3 & 0xFF);
                            ++n2;
                            ++n3;
                            continue;
                        }
                        ((CharBuffer)object).position(n2 - ((CharBuffer)object).arrayOffset());
                        object2 = this.b;
                        ((ByteBuffer)object2).position(n3 - ((ByteBuffer)object2).arrayOffset());
                        if (!Character.isHighSurrogate((char)object3)) {
                            n3 = ((Buffer)object).remaining();
                            this.b.flip();
                            object2 = CharBuffer.allocate(Math.max(this.b.remaining() + n3, this.b.capacity() / 2));
                            ...
                            n3 = ((Buffer)object).remaining();
                            this.b.flip();
                            object2 = IntBuffer.allocate(Math.max(this.b.remaining() + n3, this.b.capacity() / 4));
                            while (this.b.hasRemaining()) {
                    ...
                    ((CharBuffer)object).position(n2 - ((CharBuffer)object).arrayOffset());
                    object = this.b;
                    ((ByteBuffer)object).position(n3 - ((ByteBuffer)object).arrayOffset());
                }
            }
            return;
        }
        object = new UnsupportedOperationException("TODO");
        throw object;
    }
